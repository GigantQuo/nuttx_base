...
#if defined(CONFIG_I2C) && defined(CONFIG_SENSORS_LPS25H)
...
int lps25h_register(FAR const char *devpath, struct i2c_master_s* i2c,
...
#endif /* CONFIG_I2C && CONFIG_SENSORS_LPS25H */
