...
#define PORT_OUTVALUE_SHIFT        (13)       /* Bit 13: Initial value of output */
...
#define PORT_INT_SHIFT             (10)       /* Bits 10-12: Interrupting input control */
#define PORT_INT_MASK              (7 << PORT_INT_SHIFT)
...
#  define PORT_INT_BOTH            (3 << PORT_INT_SHIFT) /* Both edges */
#  define PORT_INT_HIGH            (4 << PORT_INT_SHIFT) /* High level */
#  define PORT_INT_LOW             (5 << PORT_INT_SHIFT) /* Low level */
...
void sam_configreset(port_pinset_t pinset);
