...
#  define I2C_CRLB_AMODE_MASKA     (0 << I2C_CRLB_AMODE_SHIFT) /* ADDRMASK used to mask ADDR */
...
#ifdef CONFIG_ARCH_FAMILY_SAMD20
#  define I2C_ADDR_SHIFT           (1)       /* Bits 1-7: Address */
#  define I2C_ADDR_MASK            (0x7f << I2C_ADDR_SHIFT)
#    define I2C_ADDR(n)            ((uint32_t)(n) << I2C_ADDR_SHIFT)
#  define I2C_ADDRMASK_SHIFT       (17)      /* Bits 17-23: Address Mask */
#  define I2C_ADDRMASK_MASK        (0x7f << I2C_ADDRMASK_SHIFT)
