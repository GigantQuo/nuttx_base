...
int SYS2_check_block_1(void)
{
    ...
    ret = SYS2_pwrup(SYSTEM_2_1V8 | SYSTEM_2_1V5);
    if (ret < 0) {
...
#if defined(CONFIG_ARCH_BOARD_APC3_ARLAN_48GE_S) || defined(CONFIG_ARCH_BOARD_APC3_ARLAN_48GE_FS)
        | SYSTEM_2_1V02_1
    ...
    for (i = 0; i < (BOARD_ADC_NUM_CHANNELS + 1); i++) {
        ...
        if ((voltages.am_channel == BOARD_ADC_3V3_CH) && (i != 0)) {
#if defined(CONFIG_ARCH_BOARD_APC3_ARLAN_48GE_S) || defined(CONFIG_ARCH_BOARD_APC3_ARLAN_24GE_S)
            /* Check +- 5% from 3V3:
            ...
            g_adc0_data_buffer[BOARD_ADC_3V3_CH_OFFSET] = (uint8_t)((ADC2MVOLT(voltages.am_data) * 2) / 100);
            ...
            /* Update the global buffer */
            g_adc0_data_buffer[BOARD_ADC_3V3_CH_OFFSET] = (uint8_t)(ADC2MVOLT(voltages.am_data) / 100);

#endif /* CONFIG_ARCH_BOARD_APC3_ARLAN_ */
        }

        /* First conversion in the group is false - ignore it */
        if ((voltages.am_channel == BOARD_ADC_1V8_CH) && (i != 0)) {
            /* Check +- 5% from 1V8:
             * There is a internal input divider /2,
             * but reference is VDDANA/2 = 1.65V.
            ...
            /* Update the global buffer */
            g_adc0_data_buffer[BOARD_ADC_1V8_CH_OFFSET] = (uint8_t)(ADC2MVOLT(voltages.am_data) / 100);
        }

        /* First conversion in the group is false - ignore it */
        if ((voltages.am_channel == BOARD_ADC_1V5_CH) && (i != 0)) {
            /* Check +- 5% from 1V5:
             * There is a internal input divider /2,
             * but reference is VDDANA/2 = 1.65V.
            ...
            /* Update the global buffer */
            g_adc0_data_buffer[BOARD_ADC_1V5_CH_OFFSET] = (uint8_t)(ADC2MVOLT(voltages.am_data) / 100);
        }

        /* First conversion in the group is false - ignore it */
        if ((voltages.am_channel == BOARD_ADC_1V02_0_CH) && (i != 0)) {
            /* Check +- 5% from 1V0:
             * There is a internal input divider /2,
             * but reference is VDDANA/2 = 1.65V.
            ...
            /* Update the global buffer */
            g_adc0_data_buffer[BOARD_ADC_1V02_0_CH_OFFSET] = (uint8_t)(ADC2MVOLT(voltages.am_data) / 100);
        }

#if defined(CONFIG_ARCH_BOARD_APC3_ARLAN_48GE_S) || defined(CONFIG_ARCH_BOARD_APC3_ARLAN_48GE_FS)
        /* First conversion in the group is false - ignore it */
        if ((voltages.am_channel == BOARD_ADC_1V02_1_CH) && (i != 0)) {
            /* Check +- 5% from 1V0:
             * There is a internal input divider /2,
             * but reference is VDDANA/2 = 1.65V.
             * Then 1.0V/2 = 0.5V <=> 1.65V
            ...
            /* Update the global buffer */
            g_adc0_data_buffer[BOARD_ADC_1V02_1_CH_OFFSET] = (uint8_t)(ADC2MVOLT(voltages.am_data) / 100);
        }
#endif /* CONFIG_ARCH_BOARD_APC3_ARLAN_48GE_-S */

#if defined(CONFIG_ARCH_BOARD_APC3_ARLAN_48GE_S) || defined(CONFIG_ARCH_BOARD_APC3_ARLAN_24GE_S)
        /* First conversion in the group is false - ignore it */
        if ((voltages.am_channel == BOARD_ADC_0V9_CH) && (i != 0)) {
            /* Check +- 5% from 0V9:
             * There is a internal input divider /2,
             * but reference is VDDANA/2 = 1.65V.
            ...
            /* Update the global buffer */
            g_adc0_data_buffer[BOARD_ADC_0V9_CH_OFFSET] = (uint8_t)(ADC2MVOLT(voltages.am_data) / 100);
        }
#endif /* CONFIG_ARCH_BOARD_APC3_ARLAN_--GE_S */
    }
...
int SYS2_check_block_2(void)
{
    ...
    for (i = 0; i < (BOARD_ADC_NUM_CHANNELS + 1); i++) {
        ...
        /* First conversion in the group is false - ignore it */
        if ((voltages.am_channel == BOARD_ADC_1V0_0_CH) && (i != 0)) {
            /* Check +- 5% from 1V0:
             * There is a internal input divider /2,
             * but reference is VDDANA/2 = 1.65V.
             * Then 1.0V/2 = 0.5V <=> 1.65V
            ...
            /* Update the global buffer */
            g_adc0_data_buffer[BOARD_ADC_1V0_0_CH_OFFSET] = (uint8_t)(ADC2MVOLT(voltages.am_data) / 100);
        }

#if defined(CONFIG_ARCH_BOARD_APC3_ARLAN_48GE_FS)
        /* First conversion in the group is false - ignore it */
        if ((voltages.am_channel == BOARD_ADC_1V0_1_CH) && (i != 0)) {
            /* Check +- 5% from 1V0:
             * There is a internal input divider /2,
             * but reference is VDDANA/2 = 1.65V.
             * Then 1.0V/2 = 0.5V <=> 1.65V
            ...
            /* Update the global buffer */
            g_adc0_data_buffer[BOARD_ADC_1V0_1_CH_OFFSET] = (uint8_t)(ADC2MVOLT(voltages.am_data) / 100);
        }
#endif /* CONFIG_ARCH_BOARD_APC3_ARLAN_48GE_FS */

        /* First conversion in the group is false - ignore it */
        if ((voltages.am_channel == BOARD_ADC_3V3_0_CH) && (i != 0)) {
            /* Check +- x% from 3V3:
             * There is a input external resistive divider /2
             * and internal input divider /2, but reference is
             * VDDANA/2 = 1.65V.
            ...
            /* Update the global buffer */
            g_adc0_data_buffer[BOARD_ADC_3V3_0_CH_OFFSET] = (uint8_t)((ADC2MVOLT(voltages.am_data) * 2) / 100);
        }

#if defined(CONFIG_ARCH_BOARD_APC3_ARLAN_48GE_FS)
        /* First conversion in the group is false - ignore it */
        if ((voltages.am_channel == BOARD_ADC_3V3_1_CH) && (i != 0)) {
            /* Check +- x% from 3V3:
             * There is a input external resistive divider /2
             * and internal input divider /2, but reference is
             * VDDANA/2 = 1.65V.
            ...
            /* Update the global buffer */
            g_adc0_data_buffer[BOARD_ADC_3V3_1_CH_OFFSET] = (uint8_t)((ADC2MVOLT(voltages.am_data) * 2) / 100);
        }
#endif /* CONFIG_ARCH_BOARD_APC3_ARLAN_48GE_FS */
    }
...
int SYS2_check_block_3(void)
{
    ...
    for (i = 0; i < (BOARD_ADC_NUM_CHANNELS + 1); i++) {
        ...
        /* First conversion in the group is false - ignore it */
        if ((voltages.am_channel == BOARD_ADC_5V0_CH) && (i != 0)) {
            /* Check +- 5% from 5V0:
             * There is a input external resistive divider /2
             * and internal input divider /2, but reference is
             * VDDANA/2 = 1.65V.
            ...
            /* Update the global buffer */
            g_adc0_data_buffer[BOARD_ADC_5V0_CH_OFFSET] = (uint8_t)((ADC2MVOLT(voltages.am_data) * 2) / 100);
        }
    }
